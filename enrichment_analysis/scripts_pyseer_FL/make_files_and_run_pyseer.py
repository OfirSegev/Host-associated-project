...
def run_pyseer(NAME):
	...
	commands = ["t_traits__" + NAME + ".tsv",
			"g_AFC_presence_absence__" + NAME + ".tsv",
	...
	#run lmm with distances + without distances
...
#	file = "/sci/labs/asafle/alexlevylab/icore-data/alex/workspace/HA_vs_NHA/data_sources/final_genomes/predictions/collapse_"+str(COLLAPSE)+"/tree_files_sample_"+str(SAMPLE)+"/tree_sample"+str(SAMPLE)+"_collapse_"+str(COLLAPSE)+"_clade_with_metadata.tsv"
	CLADE = sys.argv[1]
	prefix="/sci/labs/asafle/alexlevylab/icore-data/alex/workspace/HA_vs_NHA/data_sources/final_genomes/predictions/scripts_pyseer_FL/"
