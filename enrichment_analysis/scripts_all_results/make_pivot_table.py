...
def pivot(enrichment, min_clades):
    ...
    df=pd.read_csv("final_results/final_table_all_tests_"+enrichment+"_results_pfams_"+LABEL+"_collapse_"+COLLAPSE+".csv")
    ...
    p.to_csv("final_results/pivot_table_"+enrichment+"_results_"+COLLAPSE+"_"+LABEL+"_at_least_"+str(min_clades)+"_clades.csv")
