...
def run_best_to_plot_per_clade():
	...
	all_output.to_csv("results/to_plot/FL_"+label+"_"+enrichment+"_larger_than_"+number_of_tests_threshold+"_combined_best_candidates_to_plot_per_clade_collapse_"+collapse+"_with_odds_ratio.tsv", sep="\t", index=False)
