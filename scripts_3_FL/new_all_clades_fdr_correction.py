...
table_list = os.listdir('scoary_results_FL/raw_combined_samples')

first=True

for table_name in table_list:

	data=pd.read_csv("scoary_results_FL/raw_combined_samples/"+table_name)
...
output.to_csv("all_clade_sample_collapse_"+COLLAPSE+"_scoary_output_"+LABEL+"_fdr_updated_FL.csv", index=False)
