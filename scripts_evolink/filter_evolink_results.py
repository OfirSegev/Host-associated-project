...
df_P_A = pd.read_csv("evolink_results/"+LABEL+"_collapse_"+COLLAPSE+"__evolink_presence_absence_tables_combined.csv")
df_counts = pd.read_csv("evolink_results/"+LABEL+"_collapse_"+COLLAPSE+"__evolink_counts_tables_combined.csv")
...
#to csv outputs
df_P_A_enriched.to_csv("evolink_results/filtered_enriched_"+LABEL+"_collapse_"+COLLAPSE+"__evolink_presence_absence_tables_combined.csv", index=False)
df_P_A_depleted.to_csv("evolink_results/filtered_depleted_"+LABEL+"_collapse_"+COLLAPSE+"__evolink_presence_absence_tables_combined.csv", index=False)
df_counts_enriched.to_csv("evolink_results/filtered_enriched_"+LABEL+"_collapse_"+COLLAPSE+"__evolink_counts_tables_combined.csv", index=False)
df_counts_depleted.to_csv("evolink_results/filtered_depleted_"+LABEL+"_collapse_"+COLLAPSE+"__evolink_counts_tables_combined.csv", index=False)