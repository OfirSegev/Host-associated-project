...
def analyze_data(df,flag,type):
	...
	enriched_pfams_with_info = mer.merge(uniprot_description, on="pfam_id", how="left")
...
#read tables
df_scoary=pd.read_csv("all_clade_sample_collapse_"+COLLAPSE+"_scoary_output_"+LABEL+"_fdr_updated_FL.csv")
df_lmm=pd.read_csv("all_clade_sample_collapse_"+COLLAPSE+"_lmm_output_"+LABEL+"_fdr_updated_FL.csv")
...
output_combined.to_csv("final_results_FL/scoary_lmm_fisher_combined_results_FL_per_clade_"+LABEL+"_collapse_"+COLLAPSE+".csv",index=False)
